...
% ax.Position = [ 0.03 0.4 0.757 0.25];
...
set(gcf, 'Units', 'centimeters', 'Position', [0 0 25 11], 'PaperUnits', 'centimeters', 'PaperSize', [30 11]);
saveas(gca, 'Intro_Conglom1.pdf')

% export_fig Intro_Conglom1.eps -eps -r300 -painters -transparent
...
ylabel('True $R_t$','Interpreter','latex')
hYLabel = get(gca,'YLabel');
hYLabel.Position(1) = -5;
% set(hYLabel,'rotation',0,'VerticalAlignment','middle')
% title({'A plot to show how $R_e(t)$ is';'affected by social restrictions'},'Interpreter','latex')
legend(l([1 2]), '$R_t$ without PHM','$R_t$ with PHM', 'Interpreter','latex', 'Location', 'NorthWest')
axis([0 100 0 3])
set(gca, 'FontSize', 20)
if Printer == 1
%Save figure
set(gcf, 'Units', 'centimeters', 'Position', [0 0 25 11], 'PaperUnits', 'centimeters', 'PaperSize', [25 11]);
saveas(gcf, 'Intro_Conglom2.eps')

export_fig Intro_Conglom2.eps -eps -r300 -painters -transparent
...
legend(h([2 1 4]), '$\tilde{R}_t$', '95\% CI', 'Incidence Data', 'Location', 'NorthEast', 'Interpreter', 'latex')
...
saveas(gcf, 'Intro_Conglom3.eps')

export_fig Intro_Conglom3.eps -eps -r300 -painters -transparent
...
ylabel("Shape parameter, $k$ of"+newline+"$\tilde{R}_t$ Gamma posteriors")
xlabel('Time, $t$ (days)')
hYLabel = get(gca,'YLabel');
% set(hYLabel,'rotation',0,'VerticalAlignment','middle')
...
if Printer == 1
%Save figure
set(gcf, 'Units', 'centimeters', 'Position', [0 0 25 12], 'PaperUnits', 'centimeters', 'PaperSize', [25 12]);
saveas(gcf, 'Intro_Conglom4.eps')

export_fig Intro_Conglom4.eps -eps -r300 -painters -transparent
...
ylabel("Scale parameter, $\theta$ of"+newline+"$\tilde{R}_t$ Gamma posteriors")

xlabel('Time, $t$ (days)')
legend(h([1 2]), 'EpiEstim inference', 'Our inference', 'Location', 'NorthWest', 'Interpreter', 'latex')
hYLabel = get(gca,'YLabel');
% set(hYLabel,'rotation',0,'VerticalAlignment','middle')
...
%Save figure
set(gcf, 'Units', 'centimeters', 'Position', [0 0 25 12], 'PaperUnits', 'centimeters', 'PaperSize', [25 12]);
saveas(gcf, 'Intro_Conglom5.eps')

export_fig Intro_Conglom5.eps -eps -r300 -painters -transparent
