...
[k, d, f] = Delta_Generator_Sigmoid_1(10, -.015, -0.3);
...
legend(h([1 4 6 2 3]), '$R_t = 10$', 'Mean $\tilde{R}_t$ (original SI)', 'Mean $\tilde{R}_t$ (updated SI)', '95 \% CI (original SI)', '95 \% CI (updated SI)')

title('SI updates increasing mean by 0.065 and variance by 0.3')

%% Finding the magic c (or R_t) 
