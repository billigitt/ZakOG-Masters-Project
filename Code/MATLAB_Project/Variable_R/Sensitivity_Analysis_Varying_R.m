...
saveas(gcf, 'Area_Sensitivity_to_Mean_SI_Decreasing_R_t.eps')

export_fig Area_Sensitivity_to_Mean_SI_Decreasing_R_t.eps -eps -r300 -painters -transparent
...
%Save figure
set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 15], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
saveas(gcf, 'Mean_Sensitivity_to_Mean_SI_Decreasing_R_t.eps')

export_fig Mean_Sensitivity_to_Mean_SI_Decreasing_R_t.eps -eps -r300 -painters -transparent
