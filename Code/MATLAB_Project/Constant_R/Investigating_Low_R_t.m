...
[Delta_1, ~] = Delta_Generator_Quadratic_1(w_s_o, 0.3, +5);
w_s_a1 = w_s_o + Delta_1;
[Delta_2, ~] = Delta_Generator_Quadratic_1(w_s_o, 0.1, +5);

w_s_a2 = w_s_o + Delta_2;
[Delta_3, ~] = Delta_Generator_Quadratic_1(w_s_o, -0.1, +5);

w_s_a3 = w_s_o + Delta_3;
[Delta_4, ~] = Delta_Generator_Quadratic_1(w_s_o, -0.3, +5);

w_s_a4 = w_s_o + Delta_4;
...
para_3_incorrect = struct('seed', 1, 'total_time', total_time, 'w_s_all_actual', w_actual_3, 'w_s_all_recorded', w_control, 'switch_behaviour', switch_behaviour, 'update_behaviour', update_behaviour, 'tau', tau, 'a', 1, 'b', 5, 'I_0', 1000);

para_4_incorrect = struct('seed', 1, 'total_time', total_time, 'w_s_all_actual', w_actual_4, 'w_s_all_recorded', w_control, 'switch_behaviour', switch_behaviour, 'update_behaviour', update_behaviour, 'tau', tau, 'a', 1, 'b', 5, 'I_0', 1000);
...
para_3_correct = struct('seed', 1, 'total_time', total_time, 'w_s_all_actual', w_actual_3, 'w_s_all_recorded', w_actual_3, 'switch_behaviour', switch_behaviour, 'update_behaviour', update_behaviour, 'tau', tau, 'a', 1, 'b', 5, 'I_0', 1000);

para_4_correct = struct('seed', 1, 'total_time', total_time, 'w_s_all_actual', w_actual_4, 'w_s_all_recorded', w_actual_4, 'switch_behaviour', switch_behaviour, 'update_behaviour', update_behaviour, 'tau', tau, 'a', 1, 'b', 5, 'I_0', 1000);

para_Trivial = struct('R_t', 1.7);
